...
export function ReportPane({ report, status, query }: ReportPaneProps) {
  ...
  const showLoading =
    (status === "researching" || status === "finalizing") && !report;
        ...
        {status === "idle" ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-gray-500">
            ...
            <p className="text-sm text-center max-w-md opacity-60">
              Enter a research question below and the synthesized report will
              appear here.
            </p>
          </div>
        ) : showLoading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-gray-500">
            ...
            <p className="text-sm text-center max-w-md opacity-60">{query}</p>
          </div>
        ) : (
          /* Report Content */
